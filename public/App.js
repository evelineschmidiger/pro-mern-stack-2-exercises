    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          result = JSON.parse(body, jsonDateReviver); // Renders IssuesList with two items as two strings in DOM
...
var IssueList = /*#__PURE__*/function (_React$Component3) {
  ...
  return IssueList;
}(React.Component); // create an INSTANCE of the IssueList class
